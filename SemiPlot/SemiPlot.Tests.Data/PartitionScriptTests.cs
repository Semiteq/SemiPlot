...
public sealed class PartitionScriptTests
{
	...
	{
		Assert.Equal(expected, PartitionScript.PartitionName(new DateTime(year, month, day)));
	}
	...
	public void ThePartitionNameIgnoresTheTimeOfDay()
	{
		...
		Assert.Equal("tp2026m08d04", PartitionScript.PartitionName(noon));
	}
	...
	public void AnEndOnMidnightCreatesNoPartitionForTheFollowingDay()
	{
		...
		Assert.Equal([new DateTime(2026, 1, 1)], days);
	}
	...
	public void AnEndOneMillisecondPastMidnightCoversTheFollowingDay()
	{
		...
		Assert.Equal([new DateTime(2026, 1, 1), new DateTime(2026, 1, 2)], days);
	}
	...
	public void AnEndAtOrBeforeTheStartIsRejected(int days)
	{
		...
		Assert.Throws<ArgumentOutOfRangeException>(
			() => PartitionScript.CoveredDays(start, start.AddDays(days)));
	}
